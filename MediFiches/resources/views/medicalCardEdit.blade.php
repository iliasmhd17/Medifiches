    ...
    <div class="postition-relative">
        <div class="container mt-5 position-absolute bg-white" id="consult">
                ...
                @foreach ($data as $row)
                    ...
                    <form method="POST" action="{{ route('generate-pdf') }}" class="ms-auto">
                        ...
                        <button type="submit" class="btn" style="background: none; border: none;"
                            ...
                            <img src="{{ asset('images/down.png') }}" alt="Générer PDF"
                                style="height: 40px;">Télécharger
                        </button>
                    </form>
            </div>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><strong>Peut-il Participer ? :</strong>
                    {{ $row->can_participate ? 'Oui' : 'Non' }}</li>
                <li class="list-group-item"><strong>Est-il vacciné contre le tétanos ? :</strong>
                    {{ $row->tetanos_protected ? 'Oui' : 'Non' }}</li>
